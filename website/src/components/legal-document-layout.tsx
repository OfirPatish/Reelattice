...
export const LegalDocumentLayout = ({ title, children }: LegalDocumentLayoutProps) => (
  <div className="relative min-h-screen overflow-x-hidden bg-[#06080f] text-slate-200">
    ...
    />
    <header className="safe-top border-b border-cyan-500/10 bg-[#06080f]/95 backdrop-blur-md">
      <div className="safe-x mx-auto flex max-w-3xl items-center justify-between gap-4 px-4 py-4 md:px-6">
        <a
          href="/"
    ...
    <main className="safe-x mx-auto max-w-3xl px-4 py-8 md:px-6 md:py-12">
      <h1 className="font-display text-xl font-bold tracking-tight text-slate-100 sm:text-2xl">{title}</h1>
